...
function renderProducts(){
  ...
  // 5//append displayProducts to containProduct on HTML
  // 6. loop and create (HTML)
    for (let index in  products){
      product = products[index]
        ...
        let add_to_card = document.createElement('i');
        // add_to_card.src = "../../img/add_to_card.png"
